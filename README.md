...
If you are using __Windows__ or __Mac OS X__ simply
...
```Shell
docker build -t mysqldb github.com/kickbutts/easymysql
```
...
- Container will provide a  [standard database](https://github.com/kickbutts/EasyMySQL/blob/master/fehlstunden.sql).
- MySQL server has a user called *schueler* with a password called *geheim*
...
- __Username:__ *schueler* (you can change this, we will come to this later)
- __Password:__ *geheim* (you can change this, we will come to this later)
